...
ipcMain.on('set-ui', (_e, v) => {
  ...
  if (v.attColW !== undefined && HAS_TT) {
    ...
    Object.keys(v.attColW || {}).forEach((k) => {
      ...
      if (/^c\d$/.test(k) && n >= 20 && n <= 1200) o[k] = Math.round(n);
    });
    saveState({ attColW: o });
  }
