...
function printPaper(p, owner) {
  ...
  return new Promise((resolve) => {
    ...
    paperDoc = { title: String(p.title || p.range || '출력'),
      html: head + paper + '<script>window.addEventListener("load",function(){setTimeout(function(){window.print();},400);});</script></body></html>' };
